...
import type { THttpRequestNodeProps } from "@/types/app/components/component-props/dashboard/nodes/http-request";
...
function HttpRequestNode(props: THttpRequestNodeProps) {
