...
import { type TAnthropicNodeProps } from "@/types/app/components/component-props/dashboard/nodes/ai/anthropic";
...
function AnthropicNode(props: TAnthropicNodeProps) {
