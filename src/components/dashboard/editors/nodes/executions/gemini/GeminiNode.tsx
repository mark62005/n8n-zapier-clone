...
import { type TGeminiNodeSettingsFormProps } from "@/types/app/components/component-props/dashboard/editors/nodes/ai/gemini";
...
function GeminiNode(props: TGeminiNodeSettingsFormProps) {
