...
import { type TOpenAiNodeSettingsFormProps } from "@/types/app/components/component-props/dashboard/editors/nodes/ai/openai";
...
function OpenAiNode(props: TOpenAiNodeSettingsFormProps) {
